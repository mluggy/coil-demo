      ...
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        >
          <img
            ...
            style={{ width: 44, height: 44, borderRadius: 10, flexShrink: 0, cursor: canGoHome ? "pointer" : "default" }}
          />
            ...
            {seasons.map((s) => (
              <button
                ...
                style={{
                  ...
                  background:
                    s === season && !query ? "var(--accent-bg)" : "var(--card)",
                  color: s === season && !query ? "var(--accent)" : "var(--text-dim)",
