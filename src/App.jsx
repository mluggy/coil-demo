      ...
      {!player.playing && (
        ...
        >
          ...
          >
            ...
            {config.x_url && (<>
            <span style={{ margin: "0 8px" }}>&middot;</span>
            <a href={config.x_url} target="_blank" rel="noopener" onClick={() => trackExternalClick("twitter", "footer")} style={{ color: "var(--text-faint)", display: "flex", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "var(--text-dim)"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-faint)"; }}>
              <XLogo size={14} />
            </a>
            </>)}
            {config.linkedin_url && (<>
            <span style={{ margin: "0 8px" }}>&middot;</span>
            <a href={config.linkedin_url} target="_blank" rel="noopener" onClick={() => trackExternalClick("linkedin", "footer")} style={{ color: "var(--text-faint)", display: "flex", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "var(--text-dim)"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-faint)"; }}>
              <LinkedinLogo size={14} />
            </a>
            </>)}
            {config.facebook_url && (<>
            <span style={{ margin: "0 8px" }}>&middot;</span>
            <a href={config.facebook_url} target="_blank" rel="noopener" onClick={() => trackExternalClick("facebook", "footer")} style={{ color: "var(--text-faint)", display: "flex", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "#1877F2"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-faint)"; }}>
              <FacebookLogo size={14} />
            </a>
            </>)}
            {config.instagram_url && (<>
            <span style={{ margin: "0 8px" }}>&middot;</span>
            <a href={config.instagram_url} target="_blank" rel="noopener" onClick={() => trackExternalClick("instagram", "footer")} style={{ color: "var(--text-faint)", display: "flex", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "#E4405F"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-faint)"; }}>
              <InstagramLogo size={14} />
            </a>
            </>)}
            {config.tiktok_url && (<>
            <span style={{ margin: "0 8px" }}>&middot;</span>
            <a href={config.tiktok_url} target="_blank" rel="noopener" onClick={() => trackExternalClick("tiktok", "footer")} style={{ color: "var(--text-faint)", display: "flex", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "#00F2EA"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-faint)"; }}>
              <TiktokLogo size={14} />
            </a>
            </>)}
            ...
            {config.funding_url && (<>
            <span style={{ margin: "0 8px" }}>&middot;</span>
            <a href={config.funding_url} target="_blank" rel="noopener" onClick={() => trackExternalClick("funding", "footer")} style={{ color: "var(--text-faint)", display: "flex", transition: "color 0.15s" }} onMouseEnter={(e) => { e.currentTarget.style.color = "#db2777"; }} onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-faint)"; }}>
