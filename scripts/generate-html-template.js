...
// Insert SSR content placeholder inside #root so crawlers see real content
// before JS executes. React will replace it on mount.
...
<head>
  <!--OG_TAGS-->
  <script>window.__EPISODE__=__EP_JSON__;window.__SEARCH__=__SEARCH_JSON__;</script>
  ${cleanedHead}
</head>
<body>
  ${bodyWithSsr}
